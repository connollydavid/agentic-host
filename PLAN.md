...
| [plan/0013-verdict-lifecycle](plan/0013-verdict-lifecycle/README.md) | in progress (model host-lint's flag/warn/clean decision as a real `Check` status transition graph driven by a boundary `surface` so `allium analyse` verifies reachability/terminal/deadlock meaningfully — zero findings) |
