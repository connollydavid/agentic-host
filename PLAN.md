...
| [plan/0015-discharge-obligations](plan/0015-discharge-obligations/README.md) | in progress (use the wired skills — `weed` for spec↔code alignment, `propagate` to discharge `allium plan` obligations with tests — on host-grammar and host-lint; add `allium plan` to the CI lanes) |
