...
| [plan/0018-wire-lifecycle-as-skill](plan/0018-wire-lifecycle-as-skill/README.md) | in progress (ship host-lifecycle phase skills classify/adopt/embed/remap/verify/publish/upgrade, wire via link-skills.sh like allium; spine MUST — the lifecycle phases are unconditional, no opt-out) |
