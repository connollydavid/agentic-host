...
- Relates: `call/0002` (verification lanes by property type); `plan/0023` (the
  ...
  `software --verify-build` **in the recorded container** (host#14) — from builds to proofs.
...
- **The offline hook does only cheap structural checks**: a name-presence **lint** (the named
  harness exists — honest about being a lint, not the discharge) + **input-digest staleness**
