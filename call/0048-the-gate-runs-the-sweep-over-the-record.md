...
4. **The ledger's version floor is printed and never enforced.** It is parsed, stored, and only ever displayed. An adopter who moves the template pointer while pinned to an older tool gets a usage failure that reads as a defect in their documents.
