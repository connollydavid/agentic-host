...
milestone; both are Stage-0 standalone fixes. #8–#13 are plan/0024. The orchestration/receipts
...
Stage 0 (independent quick wins, no deps):
   ...
   host#14      ──▶ host-lifecycle release ─────────────┐
...
### Stage 0 — standalone quick wins (close host-lint#7 + host#14)
