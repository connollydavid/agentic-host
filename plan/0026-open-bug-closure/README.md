...
| **host#13** | LEXICON: tell-shaped tokens have no provenance → can only warn | **plan/0024** | line-based LEXICON; URL liveness checked by a network-having lane; warn → error |
...
milestone; both are standalone fixes. #8–#13 are plan/0024. The orchestration/receipts
...
Critical path = plan/0024 → plan/0025 (the longest chain). host-lint#7 and host#14 are off the
...
### plan/0024 — sound discharge by re-derivation + LEXICON (closes host#8–#13)
