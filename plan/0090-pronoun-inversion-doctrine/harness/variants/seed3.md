...
**The human is `you`. No lem-form is ever emitted at a human.** The table above names models only; the human is never re-pronomed.
...
- **The human is `you`. No lem-form is ever emitted at a human.** Address the human as `you`.
...
5. **The human is `you`. No lem-form is ever emitted at a human.**
